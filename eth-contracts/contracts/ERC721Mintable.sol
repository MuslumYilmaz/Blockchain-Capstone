...
contract Ownable {
    ...
    modifier onlyOwner () {
        require(msg.sender == _owner, "Only contract owner can access this method");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Please provide and actual address for the new owner");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOfToken, "Cannot approve the owner of the token.  Must be a different address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Ownership is required to transfer this token");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "This is an invalid token id");
...
contract ERC721Mintable is ERC721Metadata("Tsu Tokens", "TT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
